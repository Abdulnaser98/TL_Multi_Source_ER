...
def apply_active_learning_to_linkage_tasks(selected_tasks, tasks_dir, tasks_info_df, min_budget, total_budget, labeled_tasks_dir, active_learning_strategy, relevant_columns):
    """
