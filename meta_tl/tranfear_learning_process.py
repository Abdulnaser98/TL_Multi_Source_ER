...
def transfear_learning_process_main(selected_linkage_tasks_from_communities,active_learning_folder,path_to_record_linkage_tasks):
    for selected_linkage_task, coressponding_linkage_tasks in selected_linkage_tasks_from_communities.items():
        ...
        selected_linkage_task_df = pd.read_csv(active_learning_folder + selected_linkage_task)
        selected_linkage_task_df_processed = prepare_dataframe_prediction(selected_linkage_task_df)
    ...
    for coressponding_linkage_task in coressponding_linkage_tasks:
        ...
        coressponding_linkage_task_df_processed = prepare_dataframe_prediction(coressponding_linkage_task_df)
